...
// OpenZeppelin's Counters library
library Counters {
    struct Counter {
...
// OpenZeppelin's ERC165 standard
interface IERC165 {
    function supportsInterface(bytes4 interfaceId) external view returns (bool);
}

// OpenZeppelin's IERC1155 and extensions
...
contract ERC1155 is Context, IERC1155, IERC1155MetadataURI {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override returns (bool) {
        return interfaceId == type(IERC1155).interfaceId || interfaceId == type(IERC1155MetadataURI).interfaceId || interfaceId == type(IERC1155Receiver).interfaceId;
    }
...
contract NonTransferableNFT is ERC1155, Ownable {
    ...
    constructor() ERC1155("https://yellow-real-marsupial-155.mypinata.cloud/ipfs/QmUdAdrmHKJBaQnNYcNacwXVyACG1KKGLVNY7rsKxHRM8Z") {
        name = "Curse of the Pharaoh Pass";
        symbol = "COPP";
    }
